...
function LocationsCards() {
  return (
    <MKBox component="section" py={3} id="contact">
      <Container>
        <Grid container>
          <Grid item xs={12} md={6} lg={6} xl={6} className="mainCard">
          ...
          <Grid item xs={12} md={6} lg={6} xl={6} className="mainCard">
            <a href="https://api.whatsapp.com/send?phone=03027229664">
              {" "}
              <div className="locationMainCard">
                <Grid item className="iconDashedGrid">
                  <WhatsAppIcon className="iconSpace">phone</WhatsAppIcon>
                </Grid>
                <Grid item>
                  <MKTypography variant="h4" className="contactHeading">
                    What'sapp
