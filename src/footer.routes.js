...
// Images
import invoblink from "../src/assets/images/logo.jpg";
...
export default {
      ...
      items: [
        {
          name: "Email",
          icon: <EmailIcon />,
          description: "rafishafi98@gmail.com",
          href: "/",
        },
      ],
    },
  ...
  copyright: (
    <MKTypography variant="button" fontWeight="regular">
      Copyright &copy; 2023 <span style={{fontWeight: 'bold'}}>AL-KUWAIT & C0</span>. All Rights Reserved.{" "}
    </MKTypography>
  ),
};
